...
(function(global) {
  ...
  var Enemy = function() {
    var sprite = 'img/arcade/enemy-bug.png';
  ...
  var Collectable = function() {
    ...
    var sprite = 'img/arcade/Gem ' + randomColor + '.png';
  ...
  function drawLives() {
    ...
    for (var i = 0, len = gameState.lives; i < len; i++) {
      ctx.drawImage(Resources.get('img/arcade/Heart.png'), x, 10, 25, 43);
      x += 30;
    }
  }
  ...
  function openBugTacker() {
    window.open('https://github.com/slavo7', '_blank');
  }
